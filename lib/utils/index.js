...
exports.getSimpleIceStarkConfig = exports.getMainApi = exports.getAppsConfig = exports.iceStarkFlattenConfig = exports.MicroConfig = exports.getConfig = exports.getEnv = exports.getOriginQiankunApi = void 0;

var _react = _interopRequireDefault(require("react"));

var _lodash = require("lodash");

var _starkApp = require("@ice/stark-app");
...
var getOriginQiankunApi = function getOriginQiankunApi(config) {
  if ((0, _lodash.isArray)(config)) {
...
exports.getOriginQiankunApi = getOriginQiankunApi;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            if (!(_starkApp.isInIcestark && !isUmiQiankun)) {
              _context.next = 19;
              break;
            }
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return getEnv((0, _lodash.get)(config, 'engine'));
...
var MicroConfig = function (config) {
  var _value = {};
  return {
...
exports.MicroConfig = MicroConfig;
...
var iceStarkFlattenConfig = function iceStarkFlattenConfig(config) {
  var globalRootId = (0, _lodash.get)(config, 'mountElementId') || '';
  var apps = (0, _lodash.get)(config, 'apps') || [];
  var components = (0, _lodash.get)(config, 'components') || {};
  ...
  var routerType = (0, _lodash.get)(config, 'history') || 'hashHistory';
  return {
    apps: apps,
    rootId: globalRootId,
...
exports.iceStarkFlattenConfig = iceStarkFlattenConfig;

var changeValue = function changeValue(mappingKey, value) {
  if (!(0, _lodash.isString)(mappingKey) && (0, _lodash.isObject)(mappingKey)) {
    var _action = (0, _lodash.get)(mappingKey, 'valueChange') || {};
...
var getKey = function getKey(origin) {
  if (!(0, _lodash.isString)(origin) && (0, _lodash.isObject)(origin)) {
    var _key = (0, _lodash.get)(origin, 'key');
...
var getEngine = function getEngine(entry) {
  return (0, _lodash.isArray)(entry) ? ICE_STARK : QIAN_KUN;
};
/**
 * path补全
 * @param {*} origin
...
var fixRoutes = function fixRoutes(origin) {
  var path = (0, _lodash.get)(origin, 'path') || '';
  var basename = (0, _lodash.get)(origin, 'basename') || '';
...
var getAppsConfig = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return (0, _lodash.get)(config, 'apps');
          ...
          case 5:
            apps = _context3.t0;
            history = (0, _lodash.get)(config, 'history') || 'browser';
            mountElementId = (0, _lodash.get)(config, 'mountElementId');
            _qiankunApps = apps.map(function (_) {
              var _history = (0, _lodash.get)(_, 'history') || history;

              var _mountElementId = (0, _lodash.get)(_, 'mountElementId') || mountElementId || 'root-subapp-container';
...
var getMainApi = function getMainApi(config, engines) {
  // 根据引擎区分运行环境
...
exports.getMainApi = getMainApi;

var getSimpleIceStarkConfig = function getSimpleIceStarkConfig(iceStarkConfig) {
  var historyType = iceStarkConfig.history || 'hash';
  var Layout = (0, _lodash.get)(iceStarkConfig, 'components.LayoutComponent') || EmptyDom;

  var _ref6 = (0, _lodash.get)(iceStarkConfig, 'components') || {},
...
exports.getSimpleIceStarkConfig = getSimpleIceStarkConfig;